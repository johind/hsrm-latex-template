...
wenn Anforderungen nummeriert werden. \Cref{tab:requirements} zeigt eine
mögliche Struktur.
...
Abbildungen mit \verb|\cref|, zum Beispiel zeigt \cref{fig:example} eine
schematische Darstellung. Ist der Verweis weit vom Objekt entfernt, kann
zusätzlich \verb|\pageref| verwendet werden.
